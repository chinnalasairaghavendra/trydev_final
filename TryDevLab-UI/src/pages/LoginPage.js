        ...
        <div className="py-12 sm:py-16 flex justify-center">
          <div className="w-full max-w-md bg-white border border-slate-200 rounded-xl shadow-card p-7 sm:p-8">
            <div className="text-center">
              ...
              <div className="mt-1 text-xs text-slate-500">Log in to continue your coding journey</div>
            </div>
            ...
            <form onSubmit={onSubmit} className="mt-7 space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <button type="button" className="text-xs text-brand-600 hover:text-brand-700">Forgot password?</button>
                </div>
                <input
                  value={password}
